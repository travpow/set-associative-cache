...
/**
 * O(1) cache invalidation for a linked entry list in a bucket, using a Least Recently Used algorithm
 */
public class LRUInvalidator<K, V>
    ...
    public boolean invalidate() {
        ...
        final LinkedEntry<K, V> toRemove = head;
